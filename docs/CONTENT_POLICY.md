...
8. The first content wave ships only `automationStatus: "full"`. Rules that Affliction Forge 0.1.47 cannot faithfully automate remain outside compiled packs until the engine contract covers them.
