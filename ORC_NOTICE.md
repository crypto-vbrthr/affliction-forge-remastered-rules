...
Paizo trademarks, proper nouns, setting lore, characters, deities, locations, organizations, artwork, dialogue, plots, storylines, and trade dress are not designated as Licensed Material by this module and are intentionally excluded from the rules-data library.

## Expressly Designated Licensed Material

None beyond material that is Licensed Material or Adapted Licensed Material under the ORC License by operation of the license itself.
